...
[![Github release](https://img.shields.io/github/release/xalanq/cf-tool.svg)](https://gitcode.com/sheng_wang/cf-tool_modify/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://gitcode.com/sheng_wang/cf-tool_modify/releases)
[![Build Status](https://travis-ci.org/xalanq/cf-tool.svg?branch=master)](https://travis-ci.org/xalanq/cf-tool)
[![Go Report Card](https://goreportcard.com/badge/gitcode.com/sheng_wang/cf-tool_modify)](https://goreportcard.com/report/gitcode.com/sheng_wang/cf-tool_modify)
...
You can download the pre-compiled binary file in [here](https://gitcode.com/sheng_wang/cf-tool_modify/releases).
...
```plain
$ go get gitcode.com/sheng_wang/cf-tool_modify
$ cd $GOPATH/src/gitcode.com/sheng_wang/cf-tool_modify
 ...
 * You can download the binary file in here https://gitcode.com/sheng_wang/cf-tool_modify (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
